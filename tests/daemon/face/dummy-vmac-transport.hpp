...
#ifndef NFD_TESTS_DAEMON_FACE_DUMMY_VMAC_TRANSPORT_HPP
#define NFD_TESTS_DAEMON_FACE_DUMMY_VMAC_TRANSPORT_HPP

#include "core/common.hpp"

#include "face/null-vmac-transport.hpp"
...
class DummyVmacTransportBase : public NullVmacTransport
{
public:
  explicit
  DummyVmacTransportBase(const std::string& localUri = "dummy://",
  ...
  using NullVmacTransport::setMtu;
  using NullVmacTransport::setState;
...
private:
  ...
  void
  doSend(const Block& packet, const EndpointId& endpoint, const Name name) //override
  {
    sentPackets.push_back({packet, endpoint});
  }
...
using DummyVmacTransport = DummyVmacTransportBase<true>;

} // namespace tests
} // namespace face
} // namespace nfd

#endif // NFD_TESTS_DAEMON_FACE_DUMMY_VMAC_TRANSPORT_HPP
