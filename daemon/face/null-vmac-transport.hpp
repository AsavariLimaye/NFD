...
#ifndef NFD_DAEMON_FACE_NULL_VMAC_TRANSPORT_HPP
#define NFD_DAEMON_FACE_NULL_VMAC_TRANSPORT_HPP
 ...
 */
class NullVmacTransport FINAL_UNLESS_WITH_TESTS : public VmacTransport
{
public:
  explicit
  NullVmacTransport(const FaceUri& localUri = FaceUri("null://"),
...
private:
  ...
  void
  doSend(const Block&, const EndpointId&, Name name)
  {
  }
};
...
#endif // NFD_DAEMON_FACE_NULL_VMAC_TRANSPORT_HPP
